...
Edna umożliwia dostęp do kolekcji MP3 z dowolnego komputera mającego
dostęp do sieci. Ten program wysyła strumień MP3 po HTTP do dowolnego
odtwarzacza MP3 obsługującego odtwarzanie przez połączenie sieciowe
(jak Winamp, FreeAmp, Sonique, XMMS). Edna obsługuje także pliki Ogg.
